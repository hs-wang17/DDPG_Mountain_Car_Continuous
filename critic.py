# --------------------------------------
# Critic (With modification)
# Original author: IgnacioCarlucho
# Date: 2020.4.19
# Reference: https://github.com/IgnacioCarlucho/DDPG_MountainCar/blob/master/critic.py
# --------------------------------------
...
class CriticNetwork(object):
    ...
    def __init__(self, sess, state_dim, action_dim, learning_rate, tau, num_actor_vars, device='/cpu:0'):
        ...
        self.h_size = 300  # the size of the las hidden network before
    ...
    def recover_critic(self):
        self.saver.restore(self.sess, './save/valid_model1/critic_model.ckpt')
