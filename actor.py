# --------------------------------------
# Actor (With modification)
# Original author: IgnacioCarlucho
# Date: 2018.10.20
# Reference: https://github.com/IgnacioCarlucho/DDPG_MountainCar/blob/master/actor.py
# --------------------------------------
...
class ActorNetwork(object):
    ...
    def recover_actor(self):
        self.saver.restore(self.sess, './save/valid_model1/actor_model.ckpt')
